...
def switch_music(current_screen):
    if current_screen == "start":
        load_music("opsong.mp3")
    elif current_screen == "game":
        load_music("main.mp3")
    elif current_screen == "end":
        load_music("final.mp3")
...
while running:
    ...
    if '1' in averages and '2' in averages:
        ...
        if situation_index != None:
            ...
            pygame.display.flip()
            pygame.time.wait(50000)  # Показать результат на 5 секунд
    pygame.display.flip()
