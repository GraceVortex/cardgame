...
def calculate_precision(average_params, situation_params):
...
def draw_final_info_panel(screen, situation_params, total_error_1, total_error_2):
    ...
    labels = ['E', 'A', 'M', 'T', 'J', 'F', 'Precision 2', 'Precision 1']
...
while running:
    ...
    if '1' in averages and '2' in averages:
        ...
        if situation_index != None:
            ...
            precision_1 = calculate_precision(averages['1'], situation_params)
            precision_2 = calculate_precision(averages['2'], situation_params)
            ...
            draw_final_info_panel(screen, situations[situation_index].parameters, precision_1, precision_2)
